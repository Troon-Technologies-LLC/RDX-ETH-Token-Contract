// Simple RDX Token Bridge Script (Base to Ethereum)
...
const BASE_TOKEN_ADDRESS = '0xfa5A9C688ebe9be8CfD50a11fdc9A9A67adA4772'; // Replace with your RDX token address on Base Sepolia
const INTERCHAIN_SERVICE_ADDRESS = '0xB5FB4BE02232B1bBA4dC8f81dc24C26980dE9e3C'; // Interchain Token Service on Base Sepolia
const TOKEN_ID = '0xf75cf71962257b424c655b84d8f2d82be95a9e302681f383a7d14a24952d9f7f'; // Replace with your token ID

// Network configuration
// Move API key to .env file for better security
const BASE_RPC_URL = 'https://sepolia.base.org';
const DESTINATION_CHAIN = 'ethereum-sepolia'; // Destination chain name
...
async function checkNetworkConnection(provider) {
  try {
    ...
    if (network.chainId !== 84532n) {
      throw new Error(`Connected to wrong network. Expected Base Sepolia (84532), got ${network.name} (${network.chainId})`);
    }
...
async function bridgeTokens() {
  ...
  console.log('RDX TOKEN BRIDGE: BASE TO ETHEREUM');
  console.log('='.repeat(50));
  ...
  try {
    ...
    console.log(`Connecting to Base network at ${BASE_RPC_URL}...`);
    ...
    console.log(`You can track the transfer at: https://testnet.axelarscan.io/gmp/${transferReceipt.hash}`);
